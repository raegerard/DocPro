		...
		<div class='card-body'>
			<div class='row'>
				<div class='col-md-12' id='user-table-row'>
					<table id='purchases-table' class='table table-hover table-bordered table-striped' width='1400px'>
						<thead>
							<th>Options</th>
							<th>ID</th>
							<th>Journal</th>
	...
	<div>
		<div>
			<div  style='border-bottom: 1px groove; height: 30px; padding-bottom: 10px;'>
				...
				<h4 class="modal-title" style="font-family: 'Roboto Condensed', sans-serif;">Purchases</h4>
			</div>
