				<div class="side-body padding-top" ng-app='journal_app' ng-controller='summary_controller'  id='journal-navs'>
					<div class='row'>
						<div class='col-md-12' style='background-color: #FFF; margin-bottom: 10px;'>
							<a class='btn btn-default hvr-sweep-to-top' id='btn-sales' ng-click="select_sales()" 				<?php if($this->session->userdata('journal') === 'sales')echo "style='background-color: #000; color: #FFF;'" ?>>Sales Journal</a>
							<a class='btn btn-default hvr-sweep-to-top' id='btn-purchases' ng-click="select_purchases()"		<?php if($this->session->userdata('journal') === 'purchases')echo "style='background-color: #000; color: #FFF;'" ?>>Purchases Journal</a>
							<a class='btn btn-default hvr-sweep-to-top' id='btn-receipts' ng-click="select_receipts()"			<?php if($this->session->userdata('journal') === 'receipts')echo "style='background-color: #000; color: #FFF;'" ?>>Receipts Journal</a>
							<a class='btn btn-default hvr-sweep-to-top' id='btn-collections' ng-click="select_collections()"	<?php if($this->session->userdata('journal') === 'collections')echo "style='background-color: #000; color: #FFF;'" ?>>Collections Journal</a>
							<a class='btn btn-default hvr-sweep-to-top' id='btn-disbursements' ng-click="select_disbursements()"<?php if($this->session->userdata('journal') === 'disbursements')echo "style='background-color: #000; color: #FFF;'" ?>>Disbursements Journal</a>
							<a class='btn btn-default hvr-sweep-to-top' id='btn-general' ng-click="select_general()"			<?php if($this->session->userdata('journal') === 'general')echo "style='background-color: #000; color: #FFF;'" ?>>General Journal</a>
						</div>
					</div>
						...
						<div class='col-md-12'>
							<div role="tabpanel">
								...
								<ul class="nav nav-tabs" role="tablist">
									<li role="presentation" class="<?php if($this->session->userdata('tab') === 'summary') echo "active"?>"><a href="#summary" aria-controls="summary" role="tab" data-toggle="tab">Summary</a></li>
									<li role="presentation" class="<?php if($this->session->userdata('tab') === 'businesspartner') echo "active"?>"><a href="#business-partners" aria-controls="business-partners" role="tab" data-toggle="tab">Business Partners</a></li>
									<li role="presentation" class="<?php if($this->session->userdata('tab') === 'newtransaction') echo "active"?>"><a href="#new-transactions" aria-controls="new-transactions" role="tab" data-toggle="tab">New Transactions</a></li>
									<li role="presentation" class="<?php if($this->session->userdata('tab') === 'document') echo "active"?>"><a href="#documents" aria-controls="documents" role="tab" data-toggle="tab">Documents</a></li>
								</ul>
								<!-- Tab panes -->
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane <?php if($this->session->userdata('tab') === 'summary') echo "active"?>" id="summary">
										<div class='card'>
									...
									<div role="tabpanel" class="tab-pane <?php if($this->session->userdata('tab') === 'businesspartner') echo "active"?>" id="business-partners">
										<div class='card'>
											<div class='card-header'>
												<div class='card-title'>
									...
									<div role="tabpanel" class="tab-pane <?php if($this->session->userdata('tab') === 'newtransaction') echo "active"?>" id="new-transactions">
									...
									<div role="tabpanel" class="tab-pane <?php if($this->session->userdata('tab') === 'document') echo "active"?>" id="documents">
										<div class='row'>
											<div class='col-md-12'>
												<div class='card' style='padding-bottom: 20px;'>
													<div class='card-header'>
