														...
														<div class='col-md-10 col-md-offset-1'>
															...
															<div class='col-md-4 col-md-offset-8'>
																<table class='table' style='width: 99%'>
																	<tr>
																		<td style='padding: 5px 5px 0 0;'><label>Total</label></td>
																		<td style='padding: 5px 5px 0 0;'><input class='form-control' type='text' /></td>
																	</tr>
																	<tr>
																		<td style='padding: 5px 5px 0 0;'><label>Trade Discount</label></td>	
																		<td style='padding: 5px 5px 0 0;'><input class='form-control' type='text' /></td>
																	</tr>
																	<tr>
																		<td style='padding: 5px 5px 0 0;'><label>Net of Trade Discount</label></td>
																		<td style='padding: 5px 5px 0 0;'><input class='form-control' type='text' /></td>
																	</tr>
																</table>
															</div>
