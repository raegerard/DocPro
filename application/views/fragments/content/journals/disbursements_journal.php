								...
								<div class="tab-content">
										...
										<div class='card' style='margin-top: 20px; padding-bottom: 20px;'>
											<div class='card-header'>
												<div class='card-title' style='width: 100%;'>
													<div class='title'>
														<label style='font-weight: normal;'>Document</label>
									...
									<div role="tabpanel" class="tab-pane" id="documents">
										<div class='row'>
											<div class='col-md-12'>
												<div class='card' style='padding-bottom: 20px;'>
													<div class='card-body' style='padding: 25px; padding-top: 10px;'>
														<div class='col-md-12'>
															<form class='form-inline'>
												...
												<div class='card' style='padding-bottom: 20px;'>
													<div class='card-body' id='card-2'>
														...
														<div class='col-md-12' id='custom-col'>
															<div class='col-md-2'>
																<label style='padding: 8px;'>Withholding Tax</label>
																<label style='padding: 8px;'>Vat Withheld</label>
																<label style='padding: 8px;'>Cash Discount</label>
																<label style='padding: 8px;'>Net Amount</label>
															</div>
															<div class='col-md-3'>
																<table class='table table-bordered table-hovered' style='width: 50%'>
																	<tbody>
																		<tr>
																			<td>&nbsp; </td>
																		</tr>
