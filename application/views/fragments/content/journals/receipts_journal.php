						...
						<div class='col-md-12'>
							<div role="tabpanel">
								...
								<ul class="nav nav-tabs" role="tablist">
									...
									<li role="presentation"><a href="#documents" aria-controls="documents" role="tab" data-toggle="tab">Official Receipts</a></li>
								</ul>
								<!-- Tab panes -->
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane active" id="summary">
										<div class='card'>
											<div class='card-body' style='padding-top: 10px;'>
												<table id='receipts-journal-summary-table' class='table table-hovered table-bordered' style='min-width: 1400px;'>
													<thead>
														<th>Trans ID</th>
														<th>Trans Date</th>
														<th>Journal</th>
										...
										<div class='card' style='margin-top: 20px;'>
											...
											<div class='card-body'>
												<table id='receipts-journal-entries-table' class='table table-hovered table-bordered' style='min-width: 1400px;'>
													<thead>
														<th>BP Code</th>
														<th>BP Name</th>
														<th>Transaction</th>
									...
									<div role="tabpanel" class="tab-pane" id="business-partners">
										<div class='card'>
											<div class='card-body' style='padding-top: 10px;'>
												<table id='receipts-bp-table' class='table table-hover table-bordered table-striped table-responsive' cellspacing="0" width="1200px">
													<thead>
														<th>BP Class</th>
														<th>BP Code</th>
														<th>BP Name</th>
										...
										<div class='card' style='margin-top: 20px;'>
											...
											<div class='card-body'>
												<table id='receipts-transaction-details-table' class='table table-bordered table-hovered table-striped' width='1200px'>
													<thead>
														<th>Trans ID</th>
														<th>Trans Date</th>
														<th>Journal</th>
										...
										<div class='card' style='margin-top: 20px;'>
											...
											<div class='card-body'>
												<table id='receipts-bp-journal-entries-table' class='table table-bordered table-hovered table-striped' width='1200px'>
													<thead>
														<th>BP Code</th>
														<th>BP Name</th>
														<th>Transaction</th>
														...
														<div class='row' style='padding-left: 1%; padding-right: 1%;'>
															<table width='100%'>
																<tr>
																	...
																	<td>&nbsp;</td>
																	<td style='padding-right: 5px; padding-top: 20px;'><input class='form-control' type='text' style='border: none; background-color: #FFF; text-align: right; font-size: 14px !important;' value='Receipt Journal' readonly /></td>
